...
/** Inline sparkle glyph (avoids pulling ui-primitives CSS modules into the desktop client). */
function SparkleIcon(): React.JSX.Element {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path
        d="M8 1.5l1.6 4.9 4.9 1.6-4.9 1.6L8 14.5 6.4 9.6 1.5 8l4.9-1.6L8 1.5z"
        fill="currentColor"
      />
    </svg>
  )
