export const zh = {
  ...
  mcpDisable: '禁用',
  mcpRemove: '卸载',
  mcpManualHint: '该服务器没有可直接安装的传输方式，请按说明手动安装。',
  mcpMethodStdio: 'npx 命令',
  mcpMethodHttp: 'HTTP 端点',
  mcpRestartRequired: '安装后需要重启以启用服务器。',
  title: '社区插件市场',
  ...
  selectSource: '选择此来源',
  selectedSource: '当前来源',
  chooseInstallSourceTitle: '选择安装来源',
  chooseInstallSourceBody: '这个插件在多个来源中都可用，请选择要从哪个来源安装。',
  installFromSource: '从此来源安装',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  mcpEmpty: 'No matching MCP servers found',
  mcpInstall: 'Install',
  ...
  mcpDisable: 'Disable',
  mcpRemove: 'Uninstall',
  mcpManualHint: 'This server has no directly installable transport; install it manually following its instructions.',
  mcpMethodStdio: 'npx command',
  mcpMethodHttp: 'HTTP endpoint',
  mcpRestartRequired: 'A restart is required after installation to enable the server.',
  ...
  chooseInstallSourceTitle: 'Choose install source',
  chooseInstallSourceBody: 'This plugin is available from multiple sources. Choose which source to install from.',
  installFromSource: 'Install from this source',
